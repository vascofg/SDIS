...
public class HttpConnection {
	...
	private String sendGet(String msg) throws Exception {
		...
		String url = "http://paginas.fe.up.pt/~ei06013/sdis2/frontpage.php?"+ msg;
	...
	public static ArrayList<Inet4Address> getIps() throws SocketException, UnknownHostException{
		...
		while (networkInterfaces.hasMoreElements()) {
			...
			if (networkInterface.isUp() && !networkInterface.isLoopback())
				try {
					 ips.add((Inet4Address) networkInterface.getInetAddresses().nextElement());
				} catch (Exception e) {
